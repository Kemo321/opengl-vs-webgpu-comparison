...
def run_benchmarks() -> None:
                    ...
                    for line in output.split("\n"):
                        if line.startswith("BENCHMARK_RESULT"):
                            ...
                            results.append({
                                ...
                                "Average_Frame_Time_ms": float(avg_time),
                                "Instancing": "Yes" if instancing else "No",
                            })
    ...
    with open(csv_file, "w", newline="") as f:
        writer = csv.DictWriter(f, fieldnames=["API", "Scenario", "Average_FPS", "Average_Frame_Time_ms", "Instancing"])
        writer.writeheader()
